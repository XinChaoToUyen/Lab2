	...
	$(document).ready(function(){
		...
		$('#btnInsert').click(function(){
			...
			$.ajax({
				url:'../Process/ProcessProducts.php',
				type:'get',
				data:{type:'them',tsp:tsp, gm:gm, gc:gc, sl:sl, nn:ngay, tinhtrang:tinhtrang, tt:tt, idl:idl },
				success:function(data){
					alert(data);
					if(data=="1"){
						$('#modalAU').modal('hide');
...
,				success:function(data){
		...
		$('#btnUpdate').click(function(){
			...
			$.ajax({
				url:'../Process/ProcessProducts.php',
				type:'get',
				data:{type:'sua',id:id,tsp:tsp, gm:gm, gc:gc, sl:sl, nn:ngay, tinhtrang:tinhtrang,tt:tt, idl:idl },
				// dataType:'JSON',
				success:function(data){
					$('#modalAU').modal('hide');
					Load();
